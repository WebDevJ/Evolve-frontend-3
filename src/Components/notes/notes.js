...
export default class Notes extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            champs: [],
            items: [],
            pickImage: `url("https://www.behance.net/gallery/76009313/League-Of-Legends-Background-Art
")`,
            pickName: '',
            pickItems: [],
            counters: [],
            counterImage: `url("https://www.behance.net/gallery/76009313/League-Of-Legends-Background-Art
")`,
            counterName: '',
            counterItems: [],
            title: '',

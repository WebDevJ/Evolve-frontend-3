...
class Sim extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            champs: [],
            items: [],
            pickImage: `url("https://mir-s3-cdn-cf.behance.net/project_modules/1400/e62ac076009313.5c5ca8e8c4a85.jpg")`,
            pickName: '',
            pickItems: [],
            counters: [],
            counterImage: `url("https://mir-s3-cdn-cf.behance.net/project_modules/1400/e62ac076009313.5c5ca8e8c4a85.jpg")`,
            counterName: '',
            counterItems: [],
            title: '',
            body: '',
    ...
    componentDidMount() {
        window.onload = () => {
            // Make your API call here .render.com lags
            this.fetchData();
        };

    }

    //fetchDataWithRetry(retries = 3, delay = 1000) {
    fetchData() {
        //axios.get('https://evolve-lol-backend.herokuapp.com')
        console.log("1st fetch to /lanes ")
        axios.get('https://evolve-hqsa.onrender.com/champs')
        ...
        console.log("2nd fetch to /items ")
        axios.get('https://evolve-hqsa.onrender.com/items')
            .then(res => {
    ...
    handleInput = e => {
        ...
        axios.get('https://evolve-hqsa.onrender.com/lanes')
            .then(res => {
    ...
    handleClick = e => {
        ...
        */
        ...
        this.setState({
            pickImage: `url('https://ddragon.leagueoflegends.com/cdn/img/champion/loading/${champName}_0.jpg')`, //Changing the background images of the empty squares with the image of the champion selected.
            ...
            counterImage: `url('https://ddragon.leagueoflegends.com/cdn/img/champion/loading/${champsData[champName].counters[0].champion}_0.jpg')`, //Grabbing the image of the top counter. Hence the reason for the zero index.
        ...
        axios.get('https://evolve-hqsa.onrender.com/itemsbuild')
            .then(res => {
    ...
    render() {
        const { loading, champsData, champs, pickImage, pickName, counterImage, counters, counterName, pickItems, counterItems } = this.state;
        ...
        return (
            <div className="sim-container">
                            ...
                            {pickItems.filter(item => Number(item)).map((item, key) => ( /*Grabbing just the items numbers so they can be rendered.*/
                                <div key={key} className='item-icons' >
                                    <div className='popup'>
                                        ...
                                        <img onMouseOver={this.handleItems} onMouseOut={this.handleItems} className='items' src={`https://ddragon.leagueoflegends.com/cdn/8.6.1/img/item/${item}.png`} alt={item} />
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    <div id="champs">
                        {champs.map((champ, key) => (
                            <img className="choose grow"
                                ...
                                src={`https://ddragon.leagueoflegends.com/cdn/8.6.1/img/champion/${champ}.png`}
                                name={champ}
                                key={key}
                                alt={key}
                            />
                ...
                <div style={{ display: hide }} id="art_container">
                    {counters.slice(1).map((champ, key) => (
                        <div key={key} className="more_counters">
                            ...
                            <img
                                src={`https://ddragon.leagueoflegends.com/cdn/img/champion/loading/${champ.champion}_0.jpg`}
                ...
                <div id="share-buttons">
                    <a href="https://www.facebook.com/sharer.php?u=https://simplesharebuttons.com" target="_blank" rel="noopener noreferrer">
